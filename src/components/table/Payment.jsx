        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center backdrop-blur-md">
            <div className="bg-white p-6 rounded-lg w-[400px]">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700">To'lovni oluvchi</label>
                        <select
                            value={collector}
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700">To'lov oyi</label>
                        <select
                            value={paymentMonth}
